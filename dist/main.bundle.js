	...
	var AddingFormComponent = (function () {
	    ...
	    AddingFormComponent.prototype.show = function () {
	        ...
	        this.http.getBuilds().subscribe(function (data) {
	            ...
	            console.log('Buildings: ', _this.buildings);
	            _this.buildId = _this.buildings[0].id;
	            // console.log('this.buildId: ', this.buildId);
	            _this.http.getSuites(_this.buildId).subscribe(function (data) {
	                _this.suites = data;
	                console.log('Suites: ', _this.suites);
	                _this.suiteId = _this.suites[0].id;
	                // console.log('this.suiteId: ', this.suiteId);
	                _this.http.getResidents(_this.suiteId).subscribe(function (data) {
	    ...
	    AddingFormComponent.prototype.changeBuilding = function (id) {
	    ...
	    AddingFormComponent.prototype.changeSuite = function (id) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var HttpService = (function () {
	    ...
	    HttpService.prototype.getResidents = function (id) {
	        var headers = new http_1.Headers();
	        this.createAuthorizationHeader(headers);
	        var options = new http_1.RequestOptions({ headers: headers });
